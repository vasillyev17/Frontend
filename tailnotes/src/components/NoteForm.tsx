...
const NoteForm: React.FC<NoteFormProps> = ({ index, note, onClose }) => {
    ...
    return (
        <div className="mt-3">
            ...
            <button className="bg-teal-300 mx-3 w-24 h-8 text-white hover:bg-teal-200" onClick={handleSave}>Save</button>
            <button className="bg-teal-300 w-24 h-8 text-white hover:bg-teal-200" onClick={handleCancel}>Cancel</button>
        </div>
    );
};
